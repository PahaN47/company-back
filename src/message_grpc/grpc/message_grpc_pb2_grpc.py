...
from message_grpc.grpc import message_grpc_pb2 as message__grpc_dot_grpc_dot_message__grpc__pb2
...
class MessageController(object):
    ...
    def Create(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/company_back.message_grpc.MessageController/Create',
    ...
    def Destroy(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/company_back.message_grpc.MessageController/Destroy',
    ...
    def List(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/company_back.message_grpc.MessageController/List',
    ...
    def PartialUpdate(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/company_back.message_grpc.MessageController/PartialUpdate',
    ...
    def Retrieve(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/company_back.message_grpc.MessageController/Retrieve',
    ...
    def Update(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/company_back.message_grpc.MessageController/Update',
            message__grpc_dot_grpc_dot_message__grpc__pb2.MessageRequest.SerializeToString,
            message__grpc_dot_grpc_dot_message__grpc__pb2.MessageResponse.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
